...
class Order:
    ...
    def __repr__(self):
        ...
        msg += f'@{self.trigger_price}' if self.trigger_price else ''
    ...
    def dump_to_dict(self) -> dict:
        ...
        if self.order_type in [OrderType.Limit, OrderType.StopLimit, OrderType.TakeProfitLimit, OrderType.StopLossLimit]:
